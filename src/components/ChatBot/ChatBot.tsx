  ...
  useEffect(() => {
    if (scriptLoaded) {
      window.botpressWebChat.mergeConfig({
        ...
        stylesheet:
          mode === "dark"
            ? "https://webchat-styler-css.botpress.app/prod/code/cd6d1743-a820-411e-a323-66e621e871c1/v23861/style.css"
            : "https://webchat-styler-css.botpress.app/prod/code/cd6d1743-a820-411e-a323-66e621e871c1/v31827/style.css",
        frontendVersion: "v1",
        theme: "prism",
